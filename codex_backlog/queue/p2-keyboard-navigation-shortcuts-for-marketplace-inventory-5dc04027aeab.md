# P2 — Keyboard Navigation Shortcuts for Marketplace & Inventory

Task ID: `codex-5dc04027aeab`
Base branch: `ai-development`
Category: `accessibility`

## Why this task exists
Improves overall keyboard usability and reduces input friction during shopping sessions.

## Acceptance criteria
- Add hotkey indicators and direct keyboard mapping for common marketplace and menu actions.
...
## Evidence IDs
- `20260918T010034Z-accessibility_ux-feature-1`
