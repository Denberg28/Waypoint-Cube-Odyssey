# P2 — Visible Keyboard Focus Rings and High-Contrast Theme Option

Task ID: `codex-dd6df5d77672`
Base branch: `ai-development`
Category: `accessibility`

## Why this task exists
Currently, interface elements lack clear focus indicators, which increases cognitive load when operating the game without a mouse.

## Acceptance criteria
- Add distinct keyboard focus states and a high-contrast visual toggle in settings.
...
## Evidence IDs
- `20260918T072121Z-accessibility_ux-feature-1`
